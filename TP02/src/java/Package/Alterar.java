...
public class Alterar extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int unidade = Integer.parseInt(request.getParameter("unidade")), qtd = Integer.parseInt(request.getParameter("qtd")), id = Integer.parseInt(request.getParameter("id"));
        double preco = Float.parseFloat(request.getParameter("preco"));
        
        try {
            conn.update(id, nome, unidade, desc, qtd, preco);
            PrintWriter out = response.getWriter();
            out.println("<html><body><script type='text/javascript'>"
                      + "alert('Produto Alterado Com Sucesso');" 
                      + "location='ListaProdutos.jsp';" 
                      + "</script></body></html>");
